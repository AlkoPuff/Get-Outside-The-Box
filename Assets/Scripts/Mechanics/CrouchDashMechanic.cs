...
public class CrouchDashMechanic : MonoBehaviour
{
    public static CrouchDashMechanic Instance;
    private void Awake()
    {
        Instance = this;
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift) &&
           ...
           !(DashMechanic.Instance && DashMechanic.Instance.isDashing))
        {
    ...
    private void StartDash()
    {
        ...
        Vector3 look = GameCursorMechanic.Instance.GetLookNormal();
        dashDirection = look;
    }
